    ...
    return (
        <div className="flex min-h-[calc(100vh-var(--header-height)-var(--footer-height))] items-center justify-center">
            <div className="w-full max-w-md px-6">
                ...
                {/* Sign In Buttons */}
                {/* form action は引数なしで呼ばれるため、.bind() で provider を事前に固定する */}
                <div className="space-y-3">
                    <form action={handleSignIn.bind(null, "google")}>
                        <button
                            type="submit"
                            className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-surface px-5 py-3.5 text-sm font-semibold text-foreground cursor-pointer transition-all hover:bg-surface-alt active:scale-[0.98]"
                        >
                            <GoogleIcon />
                    ...
                    <form action={handleSignIn.bind(null, "github")}>
                        <button
                            type="submit"
                            className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-foreground px-5 py-3.5 text-sm font-semibold text-background cursor-pointer transition-all hover:opacity-90 active:scale-[0.98]"
                        >
