...
export function Footer() {
  return (
    <footer className="h-footer border-t border-border bg-background px-6">
      <div className="mx-auto flex h-full max-w-6xl flex-col items-center justify-between gap-4 text-sm text-muted sm:flex-row">
